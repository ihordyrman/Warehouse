...
using StepDefinitionAttribute = Warehouse.Core.Pipelines.Steps.StepDefinitionAttribute;
...
public class StepRegistry : IStepRegistry
{
    ...
    private void DiscoverDefinitions()
    {
        ...
        IEnumerable<Type> definitionTypes = assembly.GetTypes()
            ...
            .Where(x => x.GetCustomAttribute<Steps.StepDefinitionAttribute>() is not null)
