...
namespace Warehouse.Core.Old.Orders.Services;
...
public class OrderManager : IOrderManager
{
    ...
    public OrderManager(IDbConnection db, ILogger<OrderManager> logger, IServiceProvider serviceProvider)
    {
        this.db = db;
        this.logger = logger;
    ...
    public async Task<Result<Order>> CreateOrderAsync(CreateOrderRequest request, CancellationToken cancellationToken = default)
    {
        ...
        //     return Result<Order>.Failure(new ServiceError($"Failed to create order: {ex.Message}"));
        // }
    }
    ...
    public async Task<Result<Order>> ExecuteOrderAsync(long orderId, CancellationToken cancellationToken = default)
    {
        ...
        //     if (order is null)
        //     {
        //         return Result<Order>.Failure(new ServiceError($"Order {orderId} not found"));
        //     }
        //
        //     if (order.Status != OrderStatus.Pending)
        //     {
        //         return Result<Order>.Failure(new ServiceError($"Cannot place order in status {order.Status}"));
        //     }
        //
        //     IMarketOrderProvider? orderProvider = providers.GetValueOrDefault(order.MarketType);
        //     if (orderProvider is null)
        //     {
        //         return Result<Order>.Failure(new ServiceError($"No order provider registered for {order.MarketType}"));
        //     }
        //
        ...
        //         await dbContext.SaveChangesAsync(cancellationToken);
        //         return Result<Order>.Failure(result.ServiceError);
        //     }
        //
        ...
        //     return Result<Order>.Failure(new ServiceError($"Failed to place order: {ex.Message}"));
        // }
    }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        //     {
        //         return Result<Order>.Failure(new ServiceError($"Cannot update order in status {order.Status}"));
        //     }
        //
        ...
        //     return Result<Order>.Failure(new ServiceError($"Failed to update order: {ex.Message}"));
        // }
    }

    public async Task<Result<Order>> CancelOrderAsync(long orderId, FSharpOption<string> reason, CancellationToken cancellationToken)
    {
        throw new NotImplementedException();
    }

    async Task<FSharpOption<Order>> IOrderManager.GetOrderAsync(long orderId, CancellationToken cancellationToken)
    {
        throw new NotImplementedException();
    }

    public async Task<List<Order>> GetOrdersAsync(int workerId, FSharpOption<OrderStatus> status, CancellationToken cancellationToken)
    {
        throw new NotImplementedException();
    }

    public async Task<List<Order>> GetOrderHistoryAsync(int skip, int take, FSharpOption<OrderHistoryFilter> filter, CancellationToken cancellationToken)
    {
        throw new NotImplementedException();
    }
    ...
    public async Task<Result<Order>> CancelOrderAsync(long orderId, string? reason = null, CancellationToken cancellationToken = default)
    {
        ...
        //     {
        //         return Result<Order>.Failure(new ServiceError($"Cannot cancel order in status {order.Status}"));
        //     }
        //
        ...
        //     return Result<Order>.Failure(new ServiceError($"Failed to cancel order: {ex.Message}"));
        // }
    }
