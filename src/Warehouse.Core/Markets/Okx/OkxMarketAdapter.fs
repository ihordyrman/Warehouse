...
module OkxAdapter =
    ...
    let create (webSocket: WebSocketClient.T) (marketDataCache: IMarketDataCache) (logger: ILogger) : T =
                    ...
                    async {
                        for subscription in subscriptions do
                            ...
                            if parts.Length = 2 then
                                ...
                                let request = OkxMessageParsing.createSubscribeRequest channel symbol
                    ...
                    async {
                            ...
                            if state.ConnectionState = ConnectionState.Connected then
                                ...
                                | Ok() ->
                                    ...
                                    | Some credentials when not (isNull credentials.ApiKey) ->
                                        let authRequest = OkxAuth.createAuthRequest credentials
                        ...
                        | Unsubscribe(channel, symbol, reply) ->
                            ...
                            if not (state.Subscriptions.Contains key) then
                                ...
                                let request = OkxMessageParsing.createUnsubscribeRequest channel symbol
