            ...
            while not stoppingToken.IsCancellationRequested do
                ...
                if tick then
                    ...
                    for symbol in symbols do
                        ...
                        let! latestCandle =
                            candlestickService.GetLatestCandlestickAsync(pairSymbol, MarketType.Okx, timeframe, stoppingToken)
                        ...
                        let rec fetchBatch fromDate =
                            task {
                                ...
                                let! result =
                                    okxHttpService.GetCandlesticksAsync(pairSymbol, bar = timeframe, before = before, limit = batchSize)
