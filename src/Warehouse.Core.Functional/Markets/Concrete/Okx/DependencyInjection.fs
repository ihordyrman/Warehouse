...
type DependencyInjection =
    static member AddOkxSupport(services: IServiceCollection, configuration: IConfiguration) =
        ...
        services.AddScoped<IMarketBalanceProvider, OkxBalanceProvider>() |> ignore
