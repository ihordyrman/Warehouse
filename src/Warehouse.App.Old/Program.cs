...
using DependencyInjection = Warehouse.Core.Old.Markets.Concrete.Okx.DependencyInjection;
...
DependencyInjection.AddOkxSupport(builder.Services, builder.Configuration);
