...
using Warehouse.Backend.Features.Okx.Messages.Http;

namespace Warehouse.Backend.Features.Okx.Services;

public class OkxHttpService(IOptions<Market> okxAuthConfiguration, ILogger<OkxHttpService> logger, IHttpClientFactory httpClientFactory)
{
