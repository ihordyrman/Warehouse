...
//             .AddChoices(
//                 nameof(Instrument.BTC),
//                 nameof(Instrument.SOL),
//                 nameof(Instrument.ETH),
//                 nameof(Instrument.DOGE),
//                 nameof(Instrument.XRP),
//                 nameof(Instrument.BCH),
//                 nameof(Instrument.LTC)));
//
//     var instrument = new Pair(Enum.Parse<Instrument>(choice), Instrument.USDT);
//
...
//                 {
//                     Symbol = new Pair(inst, Instrument.USDT).ToString(),
//                     MarketType = (int)MarketType.Binance,
...
//             }
//
//             int updated = await candlestickService!.SaveCandlesticksAsync(candlesticks, CancellationToken.None);
...
//         var pair = new Pair(Enum.Parse<Instrument>(left), Instrument.USDT);
//
//         AnsiConsole.WriteLine();
//
